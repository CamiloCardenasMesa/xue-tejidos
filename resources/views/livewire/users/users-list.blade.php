            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th wire:click="order('name')" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer">
                            <div class="flex items-center justify-between">
                                name
                        ...
                        <th wire:click="order('email')" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer">
                            <div class="flex items-center justify-between">
                                email
                                <!-- sort -->
                                @if ($sort == 'email')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($users as $user)
                        <tr>
                            <td class="px-6 py-4">
                                <img class="w-8 h-8 rounded-full object-cover" src="{{ $user->profile_photo_url }}" alt="{{ 'image of ' . $user->name }}">
                            </td>
                            <td class="px-6 py-4">
                                {{ $user->name }}
                            </td>
