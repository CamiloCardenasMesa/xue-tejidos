<x-table>
    ...
    {{-- search bar --}}
    <div class="flex items-center gap-3 p-3 lg:p-6">
        <x-input class="lg:flex-1 gap-3" type="text" wire:model="search" placeholder="busca un usuario" />
        ...
        <table class="min-w-full divide-y divide-gray-200 shadow-sm">
            <thead>
                <tr>
                    ...
                    <th wire:click="order('name')" scope="col" class="w-1/4 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer">
                        <div class="flex items-center justify-between">
                            <div>
                                name and email   
                            </div>
                    ...
                    <tr class="even:bg-gray-100 odd:bg-white text-gray-700">
                        ...
                        <td class="px-3 py-4">
                            <section class="flex items-center">
                                ...
                                <article class="p-3 ml-3 bg-gray-200 rounded-lg cursor-pointer" wire:click="destroy({{ $user->id }})">
